...
public class SensorServiceTest {
	...
	public void testGetSensorNamesWhenIsNotEmpty() {
		...
		sensors.add(new SensorEntity(0, "foo", "", 0.1, 0.2));
		sensors.add(new SensorEntity(1, "bar", "", 0.3, 0.4));
	...
	public void testFindByIdFound() {
		int id = 0;
		SensorEntity sensor = new SensorEntity(id, "foo", "", 0.1, 0.2);
	...
	public void testCreate() {
		SensorEntity sensor = new SensorEntity(0, "foo", "", 0.1, 0.2);
